...
// =============================
// Navegação entre páginas com transição
// =============================
function showPage(pageId) {
  const pages = document.querySelectorAll(".chat-area, .page");
  pages.forEach(p => {
...
document.getElementById("nav-salvos").addEventListener("click", () => showPage("salvos-page"));
document.getElementById("voltar-chat").addEventListener("click", () => showPage("chat-page"));


// =============================
// Navegação para Como Usar & Sobre
// =============================
document.getElementById("nav-como-usar").addEventListener("click", () => showPage("como-usar-page"));
document.getElementById("nav-sobre").addEventListener("click", () => showPage("sobre-page"));

document.querySelectorAll(".voltar").forEach(btn => {
  btn.addEventListener("click", e => {
    const target = e.target.getAttribute("data-target") || "chat-page";
    showPage(target);
  });
});
